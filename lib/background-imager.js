...
var BackgroundImager = {
    ...
    createMediaRules: function (imageFilenames, filepath, options, callback) {
        ...
        this.getImageFileInfoArray(imageFilenames, function (err, imageFileInfoArray) {
            ...
            // ensure "1x" ruleset (non-at-rule) is first
            // besides, there is no actual query
            mediaRules.push({
                queries: null,
                rulesets: imageFileInfoHash["1x"]
            })
            // no explicit delete of key - just skip in loop below
